...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    Maintained by [DRAGO](t.me/DragoFtw)
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Support",
                    url=f"https://t.me/DragoopSupport",
                ),
                InlineKeyboardButton(
                    text="Channel",
                    url=f"https://t.me/DragoXServer",
                ),
                InlineKeyboardButton(
                    text='Ping',
            ...
            [
                InlineKeyboardButton(
                    text="GitLab",
                    url=f"https://www.gitlab.com/Dragobotz",
                ),
                InlineKeyboardButton(
                    text="GitHub",
                    url="https://www.github.com/Dragobotz",
                ),
            ],
        ])
